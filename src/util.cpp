...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\SHND
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\SHND
    // Mac: ~/Library/Application Support/SHND
    // Unix: ~/.SHND
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SHND";
#else
    fs::path pathRet;
