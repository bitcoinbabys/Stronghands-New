 ...
 * The Stronghands developers 2019
 */
    ...
    prevBlocks(0)
{
    ...
    progressBar->setStyleSheet("QProgressBar { background-color: #8C8C8C; text-align: center; color: black; border: 1px solid #4b4b4b; } QProgressBar::chunk { background: #d4af00; margin: 0px; }");
...
void BitcoinGUI::createActions()
{
    ...
    openChatroomAction->setStatusTip(tr("Open the Stronghands Discord in a web browser."));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://discord.gg/qDk47Tk"));
}
/*
