...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SHND");
    case mBTC: return QString("mSHND");
    case uBTC: return QString::fromUtf8("μSHND");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Stronghands");
    case mBTC: return QString("Milli-Stronghands (1 / 1,000)");
    case uBTC: return QString("Micro-Stronghands (1 / 1,000,000)");
    default: return QString("???");
    }
}
