...
static const int64 MINT_PROOF_OF_WORK = 1800 * COIN;
static const int64 MINT_PROOF_OF_STAKE = 2540 * COIN;
static const int64 MIN_TXOUT_AMOUNT = CENT;
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY_PPC = 100;
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const int STAKE_TARGET_SPACING = 150; // 2.5 -minute block spacing 
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 29; // minimum age for coin age 29 days
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 120; // stake age of full weight 120 days
